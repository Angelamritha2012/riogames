			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<form id="cart"  action="updateCart" method="POST" role="form" style="display: block;" >
						<div class="col-xs-2"><img class="img-responsive" src="./resource/images/${product.pimage }">
						</div>
						<div class="col-xs-4">
							<h4 class="product-name"><strong>${product.pname}</strong></h4><h4><small>${product.pdescrip}</small></h4>
						</div>
						<div class="col-xs-6">
