...
<!--
<div class="container">
  <h2>Currently Your Basket Contains Truely Awesome Product(s)</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="cta-info text-center">
                    <h3><span class="dec-tec">“</span>Making People Successful in a Changing World<span class="dec-tec">”</span> </h3>
                </div>
            </div>
        </div>
    </section>
...
<button type="submit" class="btn btn-submit">CONTINUE SHOPPING</button>
